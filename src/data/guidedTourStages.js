...
export const STAGES = [
  {
    ...
    copy:
      "We've engaged the Affinity view on your focal ingredient. Click and drag (or tap and drag) to orbit the camera. Double-click anywhere to continue.",
    gradient: 'linear-gradient(135deg, rgba(125,211,252,0.18), rgba(52,211,153,0.18))',
    accent: '#7dd3fc',
    advance: { kind: 'doubleTapOrClick' },
