 ...
 *     scallion / ramp / chive / asafoetida all share allyl-sulfide
 *     chemistry that the GNN reads as "green" because sulfides
 *     produce pungent-green aroma analogous to crushed plant tissue.
 *     The chef CSV recognizes "alliaceous green" as a distinct
 *     Tier-1 from plain green; we mirror that with a new
 *     `alliaceous_green` axis that takes priority over plain green
 *     whenever the ingredient name contains an allium token.
 *
 * Integration
 * -----------
 ...
 *     green head fires above its threshold, return 'alliaceous_green'.
 *     The "green head fires" gate ensures we don't tag e.g.
 *     "onion-glazed donut" as alliaceous when its chemistry isn't really
 *     green/sulfurous.
 ...
 *   alliaceous_green, or null when no head can be resolved
 */
