...
export default function LivingArchView({
  ...
  return (
    <div className="absolute inset-0 pt-10" role="region" aria-label="Flavor network">
      ...
      <div className="absolute bottom-[calc(var(--tab-bar-h)+80px)] sm:bottom-6 left-1/2 -translate-x-1/2 z-[71] flex items-center gap-1 px-2 py-1.5 rounded-full bg-[#0a0a12]/90 backdrop-blur-md border border-[#1e1e2e] select-none"
