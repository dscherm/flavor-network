...
2. **Read surrounding context.** For each candidate, read enough of the
   ...
   the human to read code — you read, you present.
...
- Never replace the human's judgment with your own on subjective calls
  — on *intent* questions (is this test supposed to be loose?) ask,
  don't guess.
...
- If the human says "dismiss all", respect it — write the artifact
